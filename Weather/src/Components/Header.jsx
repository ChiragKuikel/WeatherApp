...
const Header = () => {
  ...
  return (
      <div className='flex flex-row items-center justify-between bg-white p-4 pt-0 sm:mx-3 lg:mx-48 rounded-b-[2vw] '>
        ...
        <img src={`https://openweathermap.org/img/wn/${liveweather.weather?.[0].icon}@2x.png`} alt='paxi' className='flex-none '/>
        <div className='flex'>
          {/* Search button */}
    ...
    <motion.div
      ...
      >
        ...
        <div className="w-20 h-8 p-2 ml-10">
            <img src={`https://openweathermap.org/img/wn/${liveweather.weather?.[0].icon}@2x.png`} alt="Logo" className="" />
          </div>
      ...
      >
        ...
        <nav className="mt-12 text-black -ml-2">
          <ul className="space-y-4">
            ...
            <li className="flex items-center space-x-2 px-2 py-2 hover:bg-gray-100">
              <BookOpen size={20} />
              <span><Link to='/blogs' className='text-black' style={{ textDecoration: "none" }}>Blogs</Link></span>
            </li>
            <li className="flex items-center space-x-2 px-2 py-2 hover:bg-gray-100">
              <Map size={20} />
              <span>Map</span>
